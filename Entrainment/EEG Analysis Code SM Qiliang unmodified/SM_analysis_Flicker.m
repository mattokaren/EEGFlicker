...
input_dir = 'C:\Users\mattokaren3\Box\Project_FlickerBloodFlow\EEG Testing\DO NOT USE FOR FLICKER Subject MA\DO NOT USE FOR FLICKER Entrainment Testing 01OCT2019';
input_file = 'Subject MA TEST 24.4 V eyes open with 15 seconds post stim_f_1_200_butterord3_64ch'; %without .mat extension
file_name = 'Subject MA TEST 24.4 V eyes open with 15 seconds post stim';
...
peak_discrete_freq = 39.5; %freq at which to calculate peak amplitude (40Hz) MKA 2-5-20
...
peak_discrete_freq = 39.5; %freq at which to calculate peak amplitude
peak_discrete_index = find(f >= peak_discrete_freq,1);
band1 = [peak_discrete_freq-9 peak_discrete_freq-1]; 
band2 = [peak_discrete_freq+1 peak_discrete_freq+9];

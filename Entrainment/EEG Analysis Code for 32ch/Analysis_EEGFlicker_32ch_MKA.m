...
results_folder = '\AnalyzedResults';  % place to save output
...
if exist( [input_dir results_folder],'dir') == 0
    mkdir([input_dir results_folder])
end
    
save([input_dir results_folder '\' input_file file_name '.mat'], ...

function [outfilefullname, num_ch_entrained] = Analysis32ch(cleaned_file,analyzed_dir)
...
montage = 'average'; %'average', 'common', 'csd'
...
montage = 'bipolar';  % 32-channel Anterior-Posterior Bipolar Montage
...
results_folder = '\AnalyzedResults\AverageMontage';  % place to save output
...
outfilefullname = [analyzed_dir '\' input_filename out_filename '.mat'];    
